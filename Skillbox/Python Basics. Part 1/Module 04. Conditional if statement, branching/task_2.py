...
exam_russian_language = int(input("Введите количество баллов по русскому языку: "))
exam_mathematics = int(input("Введите количество баллов по математике: "))
exam_informathics = int(input("Введите количество баллов по информатике: "))

if exam_russian_language + exam_mathematics + exam_informathics >= 270:
