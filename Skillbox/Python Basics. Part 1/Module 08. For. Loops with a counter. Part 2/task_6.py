...
for month in range(1, 11):
  ...
  print(month, "месяц траты", expenses, "не хватает", expenses_total - educational_grant * month)
  expenses *= 1.03

print("Нужно попросить у родителей", expenses_total - educational_grant * 10)